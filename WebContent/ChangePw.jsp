...
<body style="font-family:Noto Sans KR;">
	<form action="ChangePw" , method="post">
		<div class="contain">
			...
			<br>
			<input type="password" name="m_Newpass" class="input" required size="20" maxlength="20" placeholder="새로운 비밀번호">
			<br>
			<input class="join" type="submit" value="비밀번호 변경" name="resister">
		</div>
	</form>
</body>
